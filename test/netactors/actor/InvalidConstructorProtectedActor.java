...
public final class InvalidConstructorProtectedActor
    extends UntypedActor
{
  /**
   * Constructor
   */
  protected InvalidConstructorProtectedActor(final IActorSystem system, final IActorConfiguration config)
  {
    super(system, config);
  }
